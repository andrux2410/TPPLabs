...
public class GenreExp {
    ...
    public void insertGenre(String genreName) {
        String sql = "INSERT INTO genre2 (genreName) VALUES (?)";
    ...
    public void updateGenre(int genreId, String newGenreName) {
        String sql = "UPDATE genre2 SET genreName = ? WHERE genre_id = ?";
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(sql)) {
    ...
    public void deleteGenre(int genreId) {
        String sql = "DELETE FROM genre2 WHERE genre_id = ?";
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(sql)) {
